...
ADD target/iotpack.jar iotpack.jar
...
EXPOSE 8080
ENTRYPOINT java ${CATALINA_OPTS} -Dfile.encoding=utf-8 -Dpinpoint.agentId=`echo material'-'$MY_NODE_NAME`  ${JAVA_OPTS}  -jar /iotpack.jar