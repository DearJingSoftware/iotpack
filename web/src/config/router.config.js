...

  {
    ...
    children: [
            ...
            // forms
      {
        ...
        component: RouteView,
        meta: { title: '设备', icon: 'form', permission: [ 'form' ] },
        children: [
          {
            path: '/device/list',
            name: 'DeviceList',
            component: () => import('@/views/device/DeviceList/DeviceList'),
            meta: { title: '设备列表', keepAlive: true, permission: [ 'form' ] }
          },
          {
            path: '/device/product',
            name: 'Product',
...

      {
        ...
        component: RouteView,
        meta: { title: '系统', icon: 'form', permission: [ 'form' ] },
        children: [
          {
            path: '/system/service',
            name: 'Service',
            component: () => import('@/views/form/basicForm'),
            meta: { title: '服务', keepAlive: true, permission: [ 'form' ] }
          },
          {
            path: '/system/setting',
            name: 'Setting',
            component: () => import('@/views/form/basicForm'),
            meta: { title: '设置', keepAlive: true, permission: [ 'form' ] }
          },
          {
            path: '/system/about',
            name: 'About',
            component: () => import('@/views/form/basicForm'),
            meta: { title: '关于', keepAlive: true, permission: [ 'form' ] }
          }
        ]
      },
      // // forms
      ...
      //   component: RouteView,
      //   meta: { title: '用户', icon: 'form', permission: [ 'form' ] },
      //   children: [
      //     {
      //       path: '/form/base-form',
      //       name: 'BaseForm',
